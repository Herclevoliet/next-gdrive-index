...
const config: z.input<typeof Schema_Config> = {
   ...
   */
  cacheControl: "public, max-age=300, s-maxage=300, stale-while-revalidate",
  ...
  apiConfig: {
     ...
     */
    rootFolder:
      "8514cbe61e698d5e2fa5f4e880bcce33052ab3ed5cd0c616c328ca413bb7009c227dafb2aae4b2ebada8ebf8b268a3ccc2;4aa6b89cf3ab06eb10179343",
  ...
  siteConfig: {
     ...
     */
    siteName: "herclegdriveindex",
    siteNameTemplate: "%s - %t",
    siteDescription: "G.Drive Index",
    siteIcon: "/logo.svg",
    siteAuthor: "Hercle",
    favIcon: "/favicon.png",
    /**
